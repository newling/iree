...
// CHECK: func.func @insert_strided_slice_r2_to_r2(%[[ARG0:.*]]: vector<1x5xf32>, %[[ARG1:.*]]: vector<4x5xf32>) -> vector<4x5xf32>
func.func @insert_strided_slice_r2_to_r2(%arg0 : vector<2x5xf32>, %arg1 : vector<4x5xf32>) -> vector<4x5xf32> {
...
func.func @insert_strided_slice_r2_to_r2(%arg0 : vector<2x4xf32>, %arg1 : vector<4x5xf32>) -> vector<4x5xf32> {
...
func.func @extract_strided_slice_r2_to_r2(%arg0 : vector<6x6xf32>) -> vector<2x6xf32> {
...
func.func @extract_strided_slice_r2_to_r2(%arg0 : vector<6x6xf32>) -> vector<2x4xf32> {
