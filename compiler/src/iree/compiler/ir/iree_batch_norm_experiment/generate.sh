...
if $SKIP_DISPATCH_SPECIFIC_GEN; then
...
for ((i=0; i<COUNT; i++)); do
    ...
    $IREE_BUILD/tools/iree-compile $BASE_FLAGS --mlir-print-ir-after-all  --mlir-print-ir-module-scope --mlir-disable-threading $OUTPUT_DIR/dispatch_$i.mlir -o $DISPATCH_DIR/abc.vmfb > $DISPATCH_DIR/after_all.mlir 2>&1
